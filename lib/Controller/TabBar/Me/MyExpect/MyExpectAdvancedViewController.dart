...
/// 我的准高级合伙人
class MyExpectAdvancedViewController extends StatefulWidget {
  static const routeName = "/me/myExpectAdvanced";

  @override
  _MyExpectAdvancedViewControllerState createState() => _MyExpectAdvancedViewControllerState();
}

class _MyExpectAdvancedViewControllerState extends State<MyExpectAdvancedViewController> {

  static List myProimary = [];
  _onRefresh() async {
    myProimary = await PartnerManager.getMyASPartnerlist();
    setState(() {});
  }
