 ...
 * "高级分红"
 */
class AdvancedEnterpriseCommissionViewController extends StatefulWidget {

  int rid;
  AdvancedEnterpriseCommissionViewController({this.rid});

  @override
  _AdvancedEnterpriseCommissionViewControllerState createState() => _AdvancedEnterpriseCommissionViewControllerState();
}

class _AdvancedEnterpriseCommissionViewControllerState extends State<AdvancedEnterpriseCommissionViewController> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text("${dividend.advancedBill}元", style: TextStyle(fontSize: 13, color: Colors.red), textAlign: TextAlign.right),
                ],
              ),
            )
          ]),
