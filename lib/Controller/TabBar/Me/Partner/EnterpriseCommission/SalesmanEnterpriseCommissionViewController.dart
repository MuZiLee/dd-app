 ...
 * 企业员的企业佣金
 */
class SalesmanEnterpriseCommissionViewController extends StatefulWidget {

  int rid;
  SalesmanEnterpriseCommissionViewController({this.rid});

  @override
  _SalesmanEnterpriseCommissionViewControllerState createState() => _SalesmanEnterpriseCommissionViewControllerState();
}

class _SalesmanEnterpriseCommissionViewControllerState extends State<SalesmanEnterpriseCommissionViewController> {
  ...
  List commissionlist = [];
  _onRefresh() async {
    commissionlist = await DividendManager.getEnterpriseCommission(Account.salesman);
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text("${dividend.salesmanBill}元", style: TextStyle(fontSize: 13, color: Colors.red), textAlign: TextAlign.right),
                ],
              ),
            )
          ]),
