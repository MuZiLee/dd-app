 ...
 * 战略企业佣金
 */
class StrategicEnterpriseCommissionViewController extends StatefulWidget {

  int rid;
  StrategicEnterpriseCommissionViewController({this.rid});

  @override
  _StrategicEnterpriseCommissionViewControllerState createState() => _StrategicEnterpriseCommissionViewControllerState();
}

class _StrategicEnterpriseCommissionViewControllerState extends State<StrategicEnterpriseCommissionViewController> {
  ...
  List commissionlist = [];
  _onRefresh() async {
    commissionlist = await DividendManager.getEnterpriseCommission(Account.strategic_alliance);
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text("${dividend.strategicBill}元", style: TextStyle(fontSize: 13, color: Colors.red), textAlign: TextAlign.right),
                ],
              ),
            )
          ]),
