...
class ArticlesModel {
    ...
    ArticlesModel({this.body, this.create_time, this.dandan_cost, this.desn, this.id, this.image, this.much_money, this.pay_count, this.title, this.type, this.visible});
