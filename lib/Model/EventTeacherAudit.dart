...
class EventTeacherAudit {
    ...
    EventTeacherAudit({this.create_time, this.etid, this.etype, this.factory, this.fid, this.id, this.jid, this.job, this.logs, this.pid, this.uid, this.update_time, this.user});

    factory EventTeacherAudit.fromJson(Map<String, dynamic> json) {
        return EventTeacherAudit(
