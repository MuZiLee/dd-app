...
abstract class CardTextViewElement {}

/// Represents an element containing a link
class LinkElement extends CardTextViewElement {
  final String url;
...
class HashTagElement extends CardTextViewElement {
  final String tag;
...
class TextElement extends CardTextViewElement {
  final String text;
...
/// Turns [text] into a list of [CardTextViewElement]
List<CardTextViewElement> _smartify(String text) {
  final sentences = text.split('\n');
  List<CardTextViewElement> span = [];
