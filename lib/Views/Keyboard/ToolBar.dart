...
class ToolBarState extends State<ToolBar>{
  ...
  double height=40;
  Color color = Color(0xffeeeeee);
  Color tintColor = Colors.deepOrange;
  ToolBarState({this.focusNodeMap,this.doneCallback,this.height=40,this.color = const Color(0xffeeeeee),this.tintColor = Colors.deepOrange});
  @override
  ...
  Widget createToolBar(ToolBarModel barModel){
    ...
    Widget doneBtn = InkWell(
        child: Text('驳回',style: TextStyle(color: tintColor),),
        onTap: doneCallback
    );
